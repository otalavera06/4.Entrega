...
<body> <!-- Body etiketa irekiten du -->
    ...
    if ($mota != '') { // Bilaketaren balioa ez bada hutsa, exekutatuko den kodea
        $sql = "SELECT id, izena, mota, prezioa FROM produktuak WHERE mota = '$mota'"; // SQL kontsulta bilaketa egingo duena motaren baitan
