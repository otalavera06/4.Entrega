...
// mota parametroa aldagai batean gorde, baliorik ez badu, hutsik utzi
$mota = $_GET['mota'] ?? ''; 

// SQL kontsulta
$sql = "SELECT * FROM produktuak WHERE mota LIKE '%$mota%'"; 
...
<head>
    ...
    <title>Motaren arabera filtratu</title> <!-- Orriaren izenburua definitu -->
    <!-- ikonoak erabiltzeko -->
...
<body>
    <h1>Motaren arabera filtratu</h1> <!-- Orriaren izenburua -->
    ...
    <form method="GET"> <!-- GET metodoa erabiliko da -->
        ...
        <input type="text" class="bilaketa" name="bilaketa" id="bilaketa"> 
        <!-- Bilaketa egiteko textu kutxa-->
    ...
    <table>
        ...
        <tbody> <!-- Taularen gorputza -->
            <?php while ($row = $result->fetch_assoc()) : ?> 
                <!-- Datu baseko lerro bakoitzeko balioak erakutsi -->
                <tr>
