...
<head> <!-- Head ireki -->
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <!-- Ikonoak gehitzeko -->
...
<body> <!-- Body ireki -->
    ...
    <form action="1ariketa.php" method="GET"> <!-- Formularioa ireki -->
        ...
        <input type="text" class="bilaketa" name="bilaketa" id="bilaketa" value="<?php echo $bilaketa; ?>"> <!-- Bilaketa egiteko textu kutxa, defektuz lehengoko bilaketa agertzen da -->
