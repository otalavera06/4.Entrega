...
<body> <!-- Body etiketa irekiten du -->
    ...
    if ($bilaketa != '') { // Bilaketaren balioa ez bada hutsa, exekutatuko den kodea
        $sql = "SELECT id, izena, mota, prezioa FROM produktuak WHERE izena LIKE '%$bilaketa%'"; // SQL kontsulta bilaketa egingo duena
    } else { // Kondizioa betetzen ez denean exekutatuko den kodea
        $sql = "SELECT id, izena, mota, prezioa FROM produktuak"; // Kondizioa betetzen ez denean exekutatuko den kodea
    ...
    <!-- Akzioa aldatu diot fitxategi bakoitzak bilaketen filtroek ongi aplikatu ditzaten -->
